      ...
      <div className="landing-container">
        ...
        <main className="landing-main">
          <div className="diag-heading-block">
            <p className="diag-title">The context becomes clearer</p>
            <p className="diag-body">
              The output changes when the context becomes clear. That is when
              the answer becomes closer to the real situation.
            </p>
          </div>
        ...
        <footer className="landing-footer">
          <span>Diagnostic Entry · Screen 1.1.2</span>
        </footer>
      </div>
    </div>
  );
