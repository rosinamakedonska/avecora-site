...
const bundle = [
  ...
  { role: "Secondary", tool: "Grammarly" },
];

export default function Diagnostic3_1() {
      ...
      <div className="landing-container">
        ...
        <main className="landing-main">
          <div className="diag-heading-block">
            <p className="diag-title">Writing and content</p>
          </div>
          ...
          <div className="bundle-block">
            ...
            <p className="diag-body">
              This combination supports idea development, stronger long-form
              writing, and cleaner final wording.
            </p>
          </div>
        ...
        <footer className="landing-footer">
          <span>Diagnostic Entry · Screen 1.3.1</span>
        </footer>
      </div>
    </div>
  );
