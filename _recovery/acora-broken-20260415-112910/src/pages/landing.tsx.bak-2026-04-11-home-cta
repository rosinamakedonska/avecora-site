      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-10 md:px-8 md:pb-20 md:pt-14">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-10 max-w-4xl leading-none text-[#111512]">
          ...
          <div className="mt-12 w-full md:mt-14">
            <div className="mx-auto flex w-full max-w-6xl items-center justify-center gap-5 rounded-full border border-[#c4b8a4] bg-[#f4ede2] px-7 py-3.5 text-center shadow-[0_4px_16px_rgba(0,0,0,0.08)]">
          ...
          <div className="mt-14 space-y-8 md:space-y-10">
            {functions.map((item, index) => (
              <article
                ...
                id={item.id}
                className={
                  "scroll-mt-8 rounded-[2rem] border px-7 py-7 shadow-[0_4px_16px_rgba(0,0,0,0.06)] md:px-9 md:py-8 " +
