...
export default function Diagnostic3_3_2() {
    ...
    Decision Systems for AI
        ...
        <main className="landing-main">
          <div className="diag-heading-block">
            <p className="diag-title">Structure and message shaping</p>
          </div>
          ...
          <div className="bundle-block">
            ...
            <p className="diag-body">
              This combination supports idea development, stronger structure,
              and faster presentation building around a clearer message.
            </p>
          </div>
